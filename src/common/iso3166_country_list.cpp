...
init() {
  ...
  g_regions.emplace_back(""s,   ""s,    142, u8"Asia"s,                                         ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     53, u8"Australia and New Zealand"s,                    ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     29, u8"Caribbean"s,                                    ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     13, u8"Central America"s,                              ""s                                                      );
  g_regions.emplace_back(""s,   ""s,    143, u8"Central Asia"s,                                 ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     14, u8"Eastern Africa"s,                               ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     30, u8"Eastern Asia"s,                                 ""s                                                      );
  g_regions.emplace_back(""s,   ""s,    151, u8"Eastern Europe"s,                               ""s                                                      );
  g_regions.emplace_back(""s,   ""s,    150, u8"Europe"s,                                       ""s                                                      );
  g_regions.emplace_back(""s,   ""s,    419, u8"Latin America and the Caribbean"s,              ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     54, u8"Melanesia"s,                                    ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     57, u8"Micronesia"s,                                   ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     17, u8"Middle Africa"s,                                ""s                                                      );
  g_regions.emplace_back(""s,   ""s,      3, u8"North America"s,                                ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     15, u8"Northern Africa"s,                              ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     21, u8"Northern America"s,                             ""s                                                      );
  g_regions.emplace_back(""s,   ""s,    154, u8"Northern Europe"s,                              ""s                                                      );
  g_regions.emplace_back(""s,   ""s,      9, u8"Oceania"s,                                      ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     61, u8"Polynesia"s,                                    ""s                                                      );
  g_regions.emplace_back(""s,   ""s,      5, u8"South America"s,                                ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     35, u8"South-Eastern Asia"s,                           ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     18, u8"Southern Africa"s,                              ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     34, u8"Southern Asia"s,                                ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     39, u8"Southern Europe"s,                              ""s                                                      );
  g_regions.emplace_back(""s,   ""s,    202, u8"Sub-Saharan Africa"s,                           ""s                                                      );
  g_regions.emplace_back(""s,   ""s,     11, u8"Western Africa"s,                               ""s                                                      );
  ...
  g_regions.emplace_back("AQ"s, "ATA"s,  10, u8"Antarctica"s,                                   u8""s                                                    );
  g_regions.emplace_back("AR"s, "ARG"s,  32, u8"Argentina"s,                                    u8"Argentine Republic"s                                  );
  g_regions.emplace_back("AS"s, "ASM"s,  16, u8"American Samoa"s,                               u8""s                                                    );
  g_regions.emplace_back("AT"s, "AUT"s,  40, u8"Austria"s,                                      u8"Republic of Austria"s                                 );
  g_regions.emplace_back("AU"s, "AUS"s,  36, u8"Australia"s,                                    u8""s                                                    );
  g_regions.emplace_back("AW"s, "ABW"s, 533, u8"Aruba"s,                                        u8""s                                                    );
  g_regions.emplace_back("AX"s, "ALA"s, 248, u8"Åland Islands"s,                                u8""s                                                    );
  g_regions.emplace_back("AZ"s, "AZE"s,  31, u8"Azerbaijan"s,                                   u8"Republic of Azerbaijan"s                              );
  g_regions.emplace_back("BA"s, "BIH"s,  70, u8"Bosnia and Herzegovina"s,                       u8"Republic of Bosnia and Herzegovina"s                  );
  ...
  g_regions.emplace_back("BL"s, "BLM"s, 652, u8"Saint Barthélemy"s,                             u8""s                                                    );
  g_regions.emplace_back("BM"s, "BMU"s,  60, u8"Bermuda"s,                                      u8""s                                                    );
  g_regions.emplace_back("BN"s, "BRN"s,  96, u8"Brunei Darussalam"s,                            u8""s                                                    );
  g_regions.emplace_back("BO"s, "BOL"s,  68, u8"Bolivia, Plurinational State of"s,              u8"Plurinational State of Bolivia"s                      );
  g_regions.emplace_back("BQ"s, "BES"s, 535, u8"Bonaire, Sint Eustatius and Saba"s,             u8"Bonaire, Sint Eustatius and Saba"s                    );
  ...
  g_regions.emplace_back("CC"s, "CCK"s, 166, u8"Cocos (Keeling) Islands"s,                      u8""s                                                    );
  g_regions.emplace_back("CD"s, "COD"s, 180, u8"Congo, The Democratic Republic of the"s,        u8""s                                                    );
  ...
  g_regions.emplace_back("CW"s, "CUW"s, 531, u8"Curaçao"s,                                      u8"Curaçao"s                                             );
  g_regions.emplace_back("CX"s, "CXR"s, 162, u8"Christmas Island"s,                             u8""s                                                    );
  ...
  g_regions.emplace_back("EH"s, "ESH"s, 732, u8"Western Sahara"s,                               u8""s                                                    );
  g_regions.emplace_back("ER"s, "ERI"s, 232, u8"Eritrea"s,                                      u8"the State of Eritrea"s                                );
  ...
  g_regions.emplace_back("FK"s, "FLK"s, 238, u8"Falkland Islands (Malvinas)"s,                  u8""s                                                    );
  ...
  g_regions.emplace_back("GB"s, "GBR"s, 826, u8"United Kingdom"s,                               u8"United Kingdom of Great Britain and Northern Ireland"s);
  g_regions.emplace_back("GD"s, "GRD"s, 308, u8"Grenada"s,                                      u8""s                                                    );
  g_regions.emplace_back("GE"s, "GEO"s, 268, u8"Georgia"s,                                      u8""s                                                    );
  g_regions.emplace_back("GF"s, "GUF"s, 254, u8"French Guiana"s,                                u8""s                                                    );
  g_regions.emplace_back("GG"s, "GGY"s, 831, u8"Guernsey"s,                                     u8""s                                                    );
  ...
  g_regions.emplace_back("GL"s, "GRL"s, 304, u8"Greenland"s,                                    u8""s                                                    );
  ...
  g_regions.emplace_back("GU"s, "GUM"s, 316, u8"Guam"s,                                         u8""s                                                    );
  g_regions.emplace_back("GW"s, "GNB"s, 624, u8"Guinea-Bissau"s,                                u8"Republic of Guinea-Bissau"s                           );
  g_regions.emplace_back("GY"s, "GUY"s, 328, u8"Guyana"s,                                       u8"Republic of Guyana"s                                  );
  g_regions.emplace_back("HK"s, "HKG"s, 344, u8"Hong Kong"s,                                    u8"Hong Kong Special Administrative Region of China"s    );
  g_regions.emplace_back("HM"s, "HMD"s, 334, u8"Heard Island and McDonald Islands"s,            u8""s                                                    );
  ...
  g_regions.emplace_back("HU"s, "HUN"s, 348, u8"Hungary"s,                                      u8"Hungary"s                                             );
  ...
  g_regions.emplace_back("IS"s, "ISL"s, 352, u8"Iceland"s,                                      u8"Republic of Iceland"s                                 );
  g_regions.emplace_back("IT"s, "ITA"s, 380, u8"Italy"s,                                        u8"Italian Republic"s                                    );
  g_regions.emplace_back("JE"s, "JEY"s, 832, u8"Jersey"s,                                       u8""s                                                    );
  ...
  g_regions.emplace_back("KP"s, "PRK"s, 408, u8"Korea, Democratic People's Republic of"s,       u8"Democratic People's Republic of Korea"s               );
  g_regions.emplace_back("KR"s, "KOR"s, 410, u8"Korea, Republic of"s,                           u8""s                                                    );
  ...
  g_regions.emplace_back("LY"s, "LBY"s, 434, u8"Libya"s,                                        u8"Libya"s                                               );
  ...
  g_regions.emplace_back("MD"s, "MDA"s, 498, u8"Moldova, Republic of"s,                         u8"Republic of Moldova"s                                 );
  g_regions.emplace_back("ME"s, "MNE"s, 499, u8"Montenegro"s,                                   u8"Montenegro"s                                          );
  g_regions.emplace_back("MF"s, "MAF"s, 663, u8"Saint Martin (French part)"s,                   u8""s                                                    );
  ...
  g_regions.emplace_back("MM"s, "MMR"s, 104, u8"Myanmar"s,                                      u8"Republic of Myanmar"s                                 );
  ...
  g_regions.emplace_back("NF"s, "NFK"s, 574, u8"Norfolk Island"s,                               u8""s                                                    );
  ...
  g_regions.emplace_back("NU"s, "NIU"s, 570, u8"Niue"s,                                         u8"Niue"s                                                );
  ...
  g_regions.emplace_back("PA"s, "PAN"s, 591, u8"Panama"s,                                       u8"Republic of Panama"s                                  );
  g_regions.emplace_back("PE"s, "PER"s, 604, u8"Peru"s,                                         u8"Republic of Peru"s                                    );
  ...
  g_regions.emplace_back("PM"s, "SPM"s, 666, u8"Saint Pierre and Miquelon"s,                    u8""s                                                    );
  g_regions.emplace_back("PN"s, "PCN"s, 612, u8"Pitcairn"s,                                     u8""s                                                    );
  g_regions.emplace_back("PR"s, "PRI"s, 630, u8"Puerto Rico"s,                                  u8""s                                                    );
  g_regions.emplace_back("PS"s, "PSE"s, 275, u8"Palestine, State of"s,                          u8"the State of Palestine"s                              );
  ...
  g_regions.emplace_back("RW"s, "RWA"s, 646, u8"Rwanda"s,                                       u8"Rwandese Republic"s                                   );
  ...
  g_regions.emplace_back("SH"s, "SHN"s, 654, u8"Saint Helena, Ascension and Tristan da Cunha"s, u8""s                                                    );
  g_regions.emplace_back("SI"s, "SVN"s, 705, u8"Slovenia"s,                                     u8"Republic of Slovenia"s                                );
  g_regions.emplace_back("SJ"s, "SJM"s, 744, u8"Svalbard and Jan Mayen"s,                       u8""s                                                    );
  ...
  g_regions.emplace_back("ST"s, "STP"s, 678, u8"Sao Tome and Principe"s,                        u8"Democratic Republic of Sao Tome and Principe"s        );
  g_regions.emplace_back("SV"s, "SLV"s, 222, u8"El Salvador"s,                                  u8"Republic of El Salvador"s                             );
  g_regions.emplace_back("SX"s, "SXM"s, 534, u8"Sint Maarten (Dutch part)"s,                    u8"Sint Maarten (Dutch part)"s                           );
  ...
  g_regions.emplace_back("TF"s, "ATF"s, 260, u8"French Southern Territories"s,                  u8""s                                                    );
  ...
  g_regions.emplace_back("TW"s, "TWN"s, 158, u8"Taiwan, Province of China"s,                    u8"Taiwan, Province of China"s                           );
  g_regions.emplace_back("TZ"s, "TZA"s, 834, u8"Tanzania, United Republic of"s,                 u8"United Republic of Tanzania"s                         );
  ...
  g_regions.emplace_back("UM"s, "UMI"s, 581, u8"United States Minor Outlying Islands"s,         u8""s                                                    );
  g_regions.emplace_back("US"s, "USA"s, 840, u8"United States"s,                                u8"United States of America"s                            );
  g_regions.emplace_back("UY"s, "URY"s, 858, u8"Uruguay"s,                                      u8"Eastern Republic of Uruguay"s                         );
  g_regions.emplace_back("UZ"s, "UZB"s, 860, u8"Uzbekistan"s,                                   u8"Republic of Uzbekistan"s                              );
  g_regions.emplace_back("VA"s, "VAT"s, 336, u8"Holy See (Vatican City State)"s,                u8""s                                                    );
  ...
  g_regions.emplace_back("VG"s, "VGB"s,  92, u8"Virgin Islands, British"s,                      u8"British Virgin Islands"s                              );
