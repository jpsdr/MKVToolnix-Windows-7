...
char const * const colour_bits_per_channel         = "colour_bits_per_channel";         // track unsigned-integer
char const * const colour_matrix_coefficients      = "colour_matrix_coefficients";      // track unsigned-integer
char const * const colour_primaries                = "colour_primaries";                // track unsigned-integer
char const * const colour_range                    = "colour_range";                    // track unsigned-integer
char const * const colour_transfer_characteristics = "colour_transfer_characteristics"; // track unsigned-integer
