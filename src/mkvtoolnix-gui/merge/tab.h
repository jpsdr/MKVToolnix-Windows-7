...
public Q_SLOTS:
  ...
  virtual void onColourMatrixCoefficientsChanged(QString newValue);
  virtual void onBitsPerColourChannelChanged(QString newValue);
  virtual void onChromaSubsamplingChanged(QString newValue);
  virtual void onCbSubsamplingChanged(QString newValue);
  virtual void onChromaSitingChanged(QString newValue);
  virtual void onColourRangeChanged(QString newValue);
  virtual void onTransferCharacteristicsChanged(QString newValue);
  virtual void onColourPrimariesChanged(QString newValue);
  virtual void onMaximumContentLightChanged(QString newValue);
  virtual void onMaximumFrameLightChanged(QString newValue);
  virtual void onChromaticityCoordinatesChanged(QString newValue);
  virtual void onWhiteColourCoordinatesChanged(QString newValue);
  virtual void onMaximumLuminanceChanged(QString newValue);
  virtual void onMinimumLuminanceChanged(QString newValue);
  virtual void onProjectionTypeChanged(QString newValue);
  virtual void onProjectionSpecificDataChanged(QString newValue);
  virtual void onYawRotationChanged(QString newValue);
  virtual void onPitchRotationChanged(QString newValue);
  virtual void onRollRotationChanged(QString newValue);
