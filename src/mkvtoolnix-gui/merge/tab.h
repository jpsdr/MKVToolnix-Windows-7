...
public Q_SLOTS:
  ...
  virtual void onColorMatrixCoefficientsChanged(QString newValue);
  virtual void onBitsPerColorChannelChanged(QString newValue);
  ...
  virtual void onColorRangeChanged(QString newValue);
  virtual void onTransferCharacteristicsChanged(QString newValue);
  virtual void onColorPrimariesChanged(QString newValue);
  ...
  virtual void onWhiteColorCoordinatesChanged(QString newValue);
