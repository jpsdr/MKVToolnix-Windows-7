...
public:
  ...
  bool m_deriveFlagsFromTrackNames, m_deriveCommentaryFlagFromFileNames, m_deriveSubtitlesForcedFlagFromFileNames, m_deriveHearingImpairedFlagFromFileNames;
  ...
  bool m_mergeEnableDialogNormGainRemoval, m_mergeAddBlurayCovers, m_mergeAttachmentsAlwaysSkipForExistingName, m_mergeEnsureAtLeastOneTrackEnabled;
