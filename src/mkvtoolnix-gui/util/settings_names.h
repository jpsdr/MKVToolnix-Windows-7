...
char const * const s_valIgnorePlaylistsForMenus                                 = "ignorePlaylistsForMenus";
...
char const * const s_valMergeEnsureAtLeastOneTrackEnabled                       = "mergeEnsureAtLeastOneTrackEnabled";
...
char const * const s_valUiPalette                                               = "uiPalette";
