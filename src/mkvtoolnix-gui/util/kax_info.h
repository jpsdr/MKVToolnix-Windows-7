...
public:
  ...
  virtual void ui_show_element_info(int level, std::string const &text, boost::optional<int64_t> position, boost::optional<int64_t> size, boost::optional<int64_t> dataSize) override;
...
signals:
  void elementInfoFound(int level, QString const &text, boost::optional<int64_t> position, boost::optional<int64_t> size, boost::optional<int64_t> dataSize);
