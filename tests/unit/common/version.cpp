...
TEST(VersionNumberT, Parsing1_2_3) {
  version_number_t v{"1.2.3"};

  ASSERT_TRUE(v.valid);
  EXPECT_EQ(1, v.parts[0]);
  EXPECT_EQ(2, v.parts[1]);
  EXPECT_EQ(3, v.parts[2]);
  EXPECT_EQ(0, v.parts[3]);
  EXPECT_EQ(0, v.parts[4]);
}
...
TEST(VersionNumberT, Stringification) {
  ...
  EXPECT_EQ(std::string{"1.2.3"}, version_number_t{"1.2.3.0"}.to_string());
  EXPECT_EQ(std::string{"1.2.3"}, version_number_t{"1.2.3.0 build 0"}.to_string());
  ...
  EXPECT_EQ(std::string{"1.2.3 build 5"}, version_number_t{"1.2.3.0 build 5"}.to_string());
  EXPECT_EQ(std::string{"1.2.3 build 5"}, version_number_t{"mkvmerge v1.2.3.0-build20170422-5"}.to_string());
}
